...
class ModelRunner:
    ...
    # NOTE(KJ.W): define a new model execute function for pipeline model execute
    @torch.inference_mode()
    def execute_pipline_model(
        self,
        seq_group_metadata_list: Optional[List[SequenceGroupMetadata]],
        kv_caches: List[Tuple[torch.Tensor, torch.Tensor]],
        cache_engine: Optional[CacheEngine],
        block_swap: Optional[Union[Dict[int, int], Dict[int, int], Dict[int, List[int]]]]
        ...
        hidden_states = model_executable(
            ...
            blocks_to_swap_in=block_swap[0],
            blocks_to_swap_out=block_swap[1],
            blocks_to_copy=block_swap[2],
        )
...
class CUDAGraphRunner:
    ...
    def forward(
        ...
        del kv_caches, cache_engine, blocks_to_swap_in, blocks_to_swap_out, blocks_to_copy
