...
class Worker:
    ...
    # NOTE(KJ.W): Add a new function to overlap swap and forward computation
    @torch.inference_mode()
    def overlapped_execute_model(
        self,
        ...
        block_swap = [blocks_to_swap_in, blocks_to_swap_out, blocks_to_copy]

        output = self.model_runner.execute_pipline_model(seq_group_metadata_list, self.gpu_cache, self.cache_engine, block_swap)
