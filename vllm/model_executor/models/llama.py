...
class LlamaModel(nn.Module):
    ...
    def __init__(
        ...
        # NOTE(KJ.W): Add self.swap_event for cuda event syncronization, and blocks parameters
        self.swap_events = [torch.cuda.Event() for _ in range(len(self.layers))]
    ...
    def forward(
        ...
        # NOTE(KJ.W): let LlamaModel have access to cache engine
        cache_engine: Optional[CacheEngine] = None,

        # NOTE(KJ.W): Add black swap parameters
...
class LlamaForCausalLM(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.model(input_ids, positions, kv_caches,
                                   input_metadata, cache_engine, blocks_to_swap_in, blocks_to_swap_out, blocks_to_copy)
        return hidden_states
